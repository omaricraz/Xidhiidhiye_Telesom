                  ...
                  <div class="col-xl-3 col-md-6">
                    <div class="card border-0 shadow-sm h-100">
                      <div class="card-body">
                        ...
                        <p class="text-muted mb-3">View comprehensive task analytics and performance metrics</p>
                  ...
                  <div class="col-xl-3 col-md-6">
                    <div class="card border-0 shadow-sm h-100">
                      <div class="card-body">
                        ...
                        <p class="text-muted mb-3">Track user engagement metrics</p>
                        <a href="{{ route('reports.users') }}" class="btn btn-success btn-sm w-100">
                          <i class="ti ti-arrow-right me-1"></i> View Report
                        </a>
                      </div>
                    </div>
                  ...
                  <div class="col-xl-3 col-md-6">
                    <div class="card border-0 shadow-sm h-100">
                      <div class="card-body">
                        ...
                        <p class="text-muted mb-3">Analyze team productivity</p>
